...
4. Connect a repository using Github
    ![Connecting the repository.](./images/render_connect_repo.jpeg)
...
7. Make sure to give a name for your static site. The publish directory should be ./static. Then, press on Deploy Static Site.
    ![Final steps in creating a static site.](./images/render_final_steps_static_site.jpeg)
8. Wait for the deployment to complete. You sould see: ‘Your site is live’. Then, just navigate to the deployed site.
    ![Deploying the static site.](./images/render_deploy_static_site.png)


### Browsing the static website
1. Click on open app or navigate to *name-of-your-app*.herokuapp.com to see the Regression Model Performance Report. 
    >Note: Replace *name-of-your-app* with the name you set in Step 1 (e.g. https://model-scoring-and-drift-using-evidently-rqy3.onrender.com).
    
    ![Regression Performance Report](./images/heroku_regression_pr.png)

2. To see the data drift dashboards generated by Evidently, navigate to https://model-scoring-and-drift-using-evidently-rqy3.onrender.com/target_drift_after_week1.html. 
    
    ![Data Drift Week 1](./images/evidently_data_drift_week1.png)

3. Replace *week1* with *week2* in the url above to see data drift after week 2.
    ![Data Drift Week 2](./images/evidently_data_drift_week2.png)

4. Replace *week2* with *week3* in the url above to see data drift after week 3.
    ![Data Drift Week 3](./images/evidently_data_drift_week3.png)
